...
<nav id="ib_navbar_nav" class="navbar navbar-default navbar-fixed-top"
	...
	<div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
				<a href="#" id="ib_navbar_manager_menu_a" class="dropdown-toggle"
				data-toggle="dropdown"> 菜品分类 <span class="caret"></span> </a>
			...
			<li><a href="/perInfoPageEnter" id="ib_navbar_reg_a"
				class="navbar-link"> ${sessionScope.user.userName} </a>
			</li>
		</ul>
	</div>
